...
\begin{figure}[H] 
\centering \includegraphics[scale=.75]{../fig/log_reg_behav/log_regression_behav_subplots.png}	 
...
\begin{figure}[H] 
\centering \includegraphics[scale=0.75]{../fig/multi_beta/std_task.png}	 
\caption{Standard Deviation of beta values on each voxel across 16 subjects on TASK condition}
\end{figure} 

\begin{figure}[H] 
\centering \includegraphics[scale=0.75]{../fig/multi_beta/tstat_task.png}	 
\caption{T-statistics of beta values on each voxel across 16 subjects on TASK condition}
\end{figure} 

\begin{figure}[H] 
\centering \includegraphics[scale=0.75]{../fig/multi_beta/pval_task.png}	 
